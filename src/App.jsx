...
import { Play, RotateCcw, Activity, Terminal } from 'lucide-react';
        ...
        <div className="min-h-screen p-4 md:p-8 flex flex-col items-center bg-slate-950 text-white">
            ...
            <div className="w-full flex flex-col items-center space-y-6">
                ...
                <div className="w-full max-w-2xl mt-8">
                    <div className="flex items-center gap-2 text-slate-500 mb-2 px-2">
                        <Terminal size={16} />
                        <span className="text-xs font-bold uppercase">Live Data Log</span>
                    </div>
                    <div className="bg-black p-4 rounded-xl border border-slate-800 font-mono text-[10px] h-32 overflow-y-auto text-green-500 shadow-inner">
                        {tickLog.length === 0 ? (
                            <div className="text-slate-700 italic">Waiting for data packets...</div>
                        ) : (
                            tickLog.map((log, i) => (
